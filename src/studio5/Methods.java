...
public class Methods {
	...
	/**
	 * Return a double that is the average of the sum of an array
	 * 
	 * @param averageThis the array that we want to find the mean of
	 * @return a double that is the average of the sum of the array given
	 */
	public static double arrayMean(int[] averageThis) {
		return ((double) arraySum(averageThis)/averageThis.length);
	}
